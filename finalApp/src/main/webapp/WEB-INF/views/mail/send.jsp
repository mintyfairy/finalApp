		...
		<div class="body-main">
			...
			<form name="mailForm" method="post" enctype="multipart/form-data">
				<table class="table mt-5 write-form">
					<tr>
						<td class="bg-light col-sm-3" scope="row">보내는 사람 이름</td>
						<td>
					...
					<tr>
						<td class="bg-light col-sm-3" scope="row">보내는 사람 E-Mail</td>
						<td>
					...
					<tr>
						<td class="bg-light col-sm-3" scope="row">받는 사람 E-Mail</td>
						<td>
					...
					<tr>
						<td class="bg-light col-sm-3" scope="row">제 목</td>
						<td>
					...
					<tr>
						<td class="bg-light col-sm-3" scope="row">내 용</td>
						<td>
					...
					<tr>
						<td class="bg-light col-sm-3">첨 부</td>
						<td> 
