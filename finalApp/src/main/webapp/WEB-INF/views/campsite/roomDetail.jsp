                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        	<div class="slideshow-container" style="z-index: 55"  >
								...
								<c:if test="${pstate==1}">
									<div style="position: absolute; top: 0; ;opacity: 0.5; "><img src="${pageContext.request.contextPath}/resource/${pageContext.request.contextPath}/resources/images/saled.png" style="width: 100%;height:450px;"/></div>
								</c:if>
								 -->
									<div class="mySlides ">
									    <img src="${pageContext.request.contextPath}/resources/images/campsite/about-1.jpg" style="bottom : 0 ;width:100%;height: 450px; overflow:hidden;object-fit:cover" 
										>
									    <div class="text" style="background: black;color:white;opacity: 0.5 "> <span >1/2</span></div>
									</div>
									<div class="mySlides">
									    <img src="${pageContext.request.contextPath}/resources/images/campsite/about-2.jpg" style="bottom : 0 ;width:100%;height: 450px; overflow:hidden;object-fit:cover" 
										>
									    <div class="text" style="background: black;color:white;opacity: 0.5 "> <span >2/2</span></div>
									</div>
            ...
            <div class="container">
                ...
                <div class="row g-4 DetailBox">
                        ...
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a class="btn btn-sm btn-primary2 rounded py-2 px-4 btnCart" data-roomNum="1">장바구니에 넣기</a>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/campsite/room-2.jpg" alt="">
                                <small class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">$100/Night</small>
                            </div>
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/campsite/room-3.jpg" alt="">
                                <small class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">$100/Night</small>
                            </div>
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
	    ...
	    <div class="modal-content">
	     ...
	     <div class="container">
				...
				<div class="modal-footer row">
					<div class="col">
						<button type="button" class="btn btn-primary2 calAJAXbtn ">${calMode=="cart"?"장바구니에 넣기":"지금 예약하기"}</button> 
					</div>
