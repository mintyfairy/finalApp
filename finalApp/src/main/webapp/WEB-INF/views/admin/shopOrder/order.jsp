...
$(function() {
	$('.orderStatus-update').click(function () {
		...
		let url = "${pageContext.request.contextPath}/admin/shopOrder/detail/" + orderNum;
		let query = "orderStatus=" + orderStatus;
		
		const fn = function(data) {
			console.log(data);
			$('#orderDialogModal').find('.modal-title').text(data[0].productName);
		};
