...
function deleteOk() {
	...
	let url = '${pageContext.request.contextPath}/admin/cs/event/${category}/delete?' + query;
		...
		<div id="tab-content" style="padding: 15px 10px 5px; clear: both;">
			...
			<table class="table">
				<tr>
					<td width="50%" align="left">
						<c:choose>
							<c:when test="${sessionScope.member.userId == dto.userId}">
				    			<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/admin/cs/event/${category}/update?num=${dto.num}&page=${page}';">수정</button>
				    		</c:when>
				    		<c:otherwise>
					...
					<td align="right">
						<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/admin/cs/event/${category}/list?${query}';">리스트</button>
					</td>
				</tr>
			</table>
		</div>		
