...
<script type="text/javascript">
    ...
    function check() {
    	...
    	f.action = "${pageContext.request.contextPath}/admin/cs/event/${category}/${mode}";
				...
				<table class="table">
					<tr> 
						<td align="center">
							...
							<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/admin/cs/event/${category}/list';">${mode=='update'?'수정취소':'등록취소'}</button>
