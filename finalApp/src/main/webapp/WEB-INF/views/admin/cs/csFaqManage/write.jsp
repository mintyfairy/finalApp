...
function sendOk() {
    ...
    f.action="${pageContext.request.contextPath}/admin/cs/faq/${mode}";
    f.submit();
}
</script>
			...
			<table class="table">
				<tr>
					<td align="center">
						...
						<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/admin/cs/faq/main?pageNo=${pageNo}';">${mode=='update'?'수정취소':'등록취소'}</button>
...
$(function(){
	...
	$(".table-form").on("click", ".btnCategoryDialog", function(){
		...
		$("#category-dialog").dialog({
			  ...
			  title: '카테고리 수정',
			  open : function(){
				let url = "${pageContext.request.contextPath}/admin/cs/faq/listAllCategory?tmp="+(new Date()).getTime();
				$(".category-list").load(url);  
			  },
			  close: function(event, ui) {
				  $("form[name=faqForm] select[name=categoryNum]").find('option').remove();
				  
				  let url = "${pageContext.request.contextPath}/admin/cs/faq/listCategory";
	...
	$("#category-dialog").on("click", ".btnCategoryAddOk", function(){	
		...
		let url = "${pageContext.request.contextPath}/admin/cs/faq/insertCategory";
		...
		const fn = function(data){
			...
			url = "${pageContext.request.contextPath}/admin/cs/csFaqManage/listAllCategory?tmp="+(new Date()).getTime();
			$(".category-list").load(url); 
		};
	...
	$(".category-list").on("click", ".btnCategoryUpdateOk", function(){	
		...
		category = encodeURIComponent(category);
		let url = "${pageContext.request.contextPath}/admin/cs/csFaqManage/updateCategory";
	...
	$(".category-list").on("click", ".btnCategoryDeleteOk", function(){
		...
		let url = "${pageContext.request.contextPath}/admin/cs/csFaqManage/deleteCategory";
