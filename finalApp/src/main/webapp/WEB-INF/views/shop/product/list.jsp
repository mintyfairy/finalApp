...
<div class="container">
    <div class="wrap">
        ...
        <div class="goods_wrap">
            <ul class="goods_list">
                <li class="goods_item">
                    <a href="#" class="goods_photo">
                        <img src="https://via.placeholder.com/250x250" alt="goods_item">
                    </a>
                    <div class="goods_text">
                        <p class="goods_brand">브랜드 이름</p>
                        <p class="goods_title">상품 이름 <span class="goods_sale">15% 할인</span></p>
                        <p class="price">원가</p>
