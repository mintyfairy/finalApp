                ...
                <form name="memberForm" method="post">
                    ...
                    <div class="col-sm-10 userId-box">
                      <div class="row">
                        ...
                        <div class="col-3 ps-1">
                            ...
                            <button type="button" class="btn btn-light" onclick="userIdCheck();" style="width: 150px;">아이디중복검사</button>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="userName" id="userName" class="form-control" value="${dto.userName}" ${mode=="update"?"readonly":""} >
                        </div>
                    </div>
                   ...
                   <div class="row mb-3">
                      ...
                      <div class="col-sm-10 row emailbox">
	                    ...
	                    <div class="col input-group">
	                      ...
	                      <input type="text" name="email2"  class="form-control" maxlength="30"  readonly>
	                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10 row">
                          ...
                          <div class="col-sm-3 ps-1">
                            <input type="text" name="tel3" id="tel3" class="form-control" value="${dto.tel2}" maxlength="4">
                          </div>
                        </div>
                    </div>
